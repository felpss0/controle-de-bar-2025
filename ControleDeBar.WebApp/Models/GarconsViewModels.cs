...
namespace ControleDeBar.WebApp.Models
{
    public class FormularioGarcomViewModel
    {
        ...
        [MaxLength(100, ErrorMessage = "O campo \"Nome\" precisa conter no maximo 100 caracteres.")]
        public string Nome { get; set; }

        [Required(ErrorMessage = "O campo \"CPF\" é obrigatorio.")]
        [RegularExpression(@"^\d{3}\.\d{3}\.\d{3}-\d{2}$",
            ErrorMessage = "O campo \"CPF\" precisa seguir o seguinte formato: 000.000.000-00.")]
